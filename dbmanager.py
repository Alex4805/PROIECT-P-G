from sqlalchemy import create_engine, Column, Integer, String, Text, ForeignKey, DECIMAL, ForeignKeyConstraint
from sqlalchemy.orm import declarative_base, sessionmaker, relationship

# 🔌 MySQL connection
DATABASE_URL = "mysql+pymysql://root:@localhost/dbProiectP&G"
...
class IdentifierCharacteristic(Base):
    ...
    # Eliminăm ForeignKey de aici:
    master_name = Column(String(255), primary_key=True)
    characteristic_name = Column(String(255), primary_key=True)
    
    # Adăugăm ForeignKeyConstraint compus:
    __table_args__ = (
        ForeignKeyConstraint(
            ['master_name', 'characteristic_name'], # Coloanele din acest tabel
            ['Characteristics.master_name', 'Characteristics.name'] # Coloanele din tabelul referențiat
        ),
    )
    ...
    identifier = relationship('Identifier')
    primaryjoin="and_(IdentifierCharacteristic.master_name==Characteristic.master_name, IdentifierCharacteristic.characteristic_name==Characteristic.name)"
...
def populate_database():
    try:
        ...
        # 6. Adăugăm Characteristics (am transformat NULL în None)
        characteristics = [
            # Shampoo
            ...
            Characteristic(master_name='CM-10004', name='Color', specifics='Shampoo Color', action_required='INSPECT', report_type='ATTRIBUTE', data_type='String', lower_routine_release_limit=None, lower_limit=None, lower_target=None, target=None, upper_target=None, upper_limit=None, upper_routine_release_limit=None, test_frequency=1, precision=0, engineering_unit=''),
            Characteristic(master_name='CM-10005', name='Fragrance', specifics='Shampoo Fragrance', action_required='INSPECT', report_type='ATTRIBUTE', data_type='String', lower_routine_release_limit=None, lower_limit=None, lower_target=None, target=None, upper_target=None, upper_limit=None, upper_routine_release_limit=None, test_frequency=1, precision=0, engineering_unit=''),
            ...
            Characteristic(master_name='CM-20003', name='Carton Dimensions', specifics='Dimensions of Carton', action_required='CONTROL', report_type='VARIABLE', data_type='String', lower_routine_release_limit=None, lower_limit=None, lower_target=None, target=None, upper_target=None, upper_limit=None, upper_routine_release_limit=None, test_frequency=1, precision=0, engineering_unit=''),
            Characteristic(master_name='CM-20004', name='Carton Material', specifics='Material of Carton', action_required='INSPECT', report_type='ATTRIBUTE', data_type='String', lower_routine_release_limit=None, lower_limit=None, lower_target=None, target=None, upper_target=None, upper_limit=None, upper_routine_release_limit=None, test_frequency=1, precision=0, engineering_unit=''),
            Characteristic(master_name='CM-20005', name='Carton Color', specifics='Color of Carton', action_required='INSPECT', report_type='ATTRIBUTE', data_type='String', lower_routine_release_limit=None, lower_limit=None, lower_target=None, target=None, upper_target=None, upper_limit=None, upper_routine_release_limit=None, test_frequency=1, precision=0, engineering_unit=''),
            # Packaging Box
            ...
            Characteristic(master_name='CM-30003', name='Box Dimensions', specifics='Dimensions of Box', action_required='CONTROL', report_type='VARIABLE', data_type='String', lower_routine_release_limit=None, lower_limit=None, lower_target=None, target=None, upper_target=None, upper_limit=None, upper_routine_release_limit=None, test_frequency=1, precision=0, engineering_unit=''),
            Characteristic(master_name='CM-30004', name='Box Material', specifics='Material of Box', action_required='INSPECT', report_type='ATTRIBUTE', data_type='String', lower_routine_release_limit=None, lower_limit=None, lower_target=None, target=None, upper_target=None, upper_limit=None, upper_routine_release_limit=None, test_frequency=1, precision=0, engineering_unit=''),
            Characteristic(master_name='CM-30005', name='Box Color', specifics='Color of Box', action_required='INSPECT', report_type='ATTRIBUTE', data_type='String', lower_routine_release_limit=None, lower_limit=None, lower_target=None, target=None, upper_target=None, upper_limit=None, upper_routine_release_limit=None, test_frequency=1, precision=0, engineering_unit=''),
            # Chemical Substance
            ...
            Characteristic(master_name='CM-40005', name='Chemical Color', specifics='Color of Chemical Substance', action_required='INSPECT', report_type='ATTRIBUTE', data_type='String', lower_routine_release_limit=None, lower_limit=None, lower_target=None, target=None, upper_target=None, upper_limit=None, upper_routine_release_limit=None, test_frequency=1, precision=0, engineering_unit=''),
            # Water
            ...
            Characteristic(master_name='CM-50005', name='Water Color', specifics='Color of Water', action_required='INSPECT', report_type='ATTRIBUTE', data_type='String', lower_routine_release_limit=None, lower_limit=None, lower_target=None, target=None, upper_target=None, upper_limit=None, upper_routine_release_limit=None, test_frequency=1, precision=0, engineering_unit=''),
            # Shampoo Bottle
            ...
            Characteristic(master_name='CM-60005', name='Bottle Material', specifics='Material of Shampoo Bottle', action_required='INSPECT', report_type='ATTRIBUTE', data_type='String', lower_routine_release_limit=None, lower_limit=None, lower_target=None, target=None, upper_target=None, upper_limit=None, upper_routine_release_limit=None, test_frequency=1, precision=0, engineering_unit='')
        ]
        session.add_all(characteristics)

        # 7. Adăugăm IdentifierCharacteristics
        ...
        # În caz de eroare, anulăm tranzacția pentru a nu lăsa date incomplete
        session.rollback()
        print(f"Eroare la inserarea datelor: {e}")

# Apelăm funcția pentru a popula baza de date
populate_database()
